...
export default class extends React.Component {
    constructor(props) {
        super(props);
        this.onMagnify = this.onMagnify.bind(this);
        this.onUnmagnify = this.onUnmagnify.bind(this);
    }
    ...
    render() {
        ...
        return (
            <div
                ...
                onMouseMove={this.onMagnify}
                onMouseLeave={this.onUnmagnify}
                style={{
                    display: "grid",
                    gridTemplateColumns: "auto auto auto",
                }}
            >
                <DockOffset width={offsetLeft} height={this.unmagnifiedDockItemWidth} magnifyDirection={this.magnifyDirection} debug={this.props.debug} />
                <Dock backgroundClassName={this.props.backgroundClassName} itemWidths={itemWidths} height={this.unmagnifiedDockItemWidth} magnifyDirection={this.magnifyDirection} debug={this.props.debug}>
                    {this.props.children}
                </Dock>
                <DockOffset width={offsetRight} height={this.unmagnifiedDockItemWidth} magnifyDirection={this.magnifyDirection} debug={this.props.debug} />
            </div>
        );
    }
